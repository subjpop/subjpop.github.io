...
br.getPageURI = function (index, reduce, rotate) {
    ...
    var url = '/images/2018-ranking/' + leafStr.replace(re, imgStr) + '.jpg';
    return url;
};
...
br.bookTitle = 'SUBJPOP・SUBJHOP 最佳日音唱片年度总选 2018';
br.bookUrl = "https://pan.baidu.com/s/1Lo7s2y6TvdNInvtKvwjrzg";
